// write some comments describing the data structures that need to be created - copy details into array
// must have a function that the other modules can invoke in order to see today's catch
// The array of fish objects will be the return value when the function is invoked

// fishing boat must have a function that the other modules can invoke in order to see today's catch module.exports = { boatInventory }
